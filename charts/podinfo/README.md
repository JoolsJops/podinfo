...
[GitHub Container Registry](https://github.com/JoolsJops/podinfo/pkgs/container/charts%2Fpodinfo)
...
```console
$ helm upgrade -i my-release oci://ghcr.io/JoolsJops/charts/podinfo
```

To verify a chart with Cosign:

```console
$ cosign verify ghcr.io/JoolsJops/charts/podinfo:<VERSION>
```
...
| `image.repository`                | `JoolsJops/podinfo` | Image repository                                                                                                       |
