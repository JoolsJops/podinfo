...
import (
	...
	"github.com/JoolsJops/podinfo/pkg/api"
	"github.com/JoolsJops/podinfo/pkg/grpc"
	"github.com/JoolsJops/podinfo/pkg/signals"
	"github.com/JoolsJops/podinfo/pkg/version"
...
func main() {
	...
	viper.SetDefault("ui-logo", "https://raw.githubusercontent.com/JoolsJops/podinfo/gh-pages/cuddle_clap.gif")
